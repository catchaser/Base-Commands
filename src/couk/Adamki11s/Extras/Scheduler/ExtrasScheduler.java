...
public class ExtrasScheduler extends SchedulerMethods {
	...
	public void scheduleAsyncRepeatingTask(int seconds,
		...
		if(_method != null){
			taskid = s.getScheduler().scheduleAsyncRepeatingTask(p, new Runnable() {	
				...
				public void run() {
					try {
						...
						System.out.println("[Extras][Scheduler] IllegalArguament Exception! Caused by plugin : " + Extras.BaseCommands);
						e.printStackTrace();
					} catch (IllegalAccessException e) {
						System.out.println("[Extras][Scheduler] IllegalAccess Exception! Caused by plugin : " + Extras.BaseCommands);
						e.printStackTrace();
					} catch (InvocationTargetException e) {
						System.out.println("[Extras][Scheduler] InvocationTarget Exception! Caused by plugin : " + Extras.BaseCommands);
						e.printStackTrace();
					} catch (InstantiationException e) {
						System.out.println("[Extras][Scheduler] Instantiation Exception! Caused by plugin : " + Extras.BaseCommands);
						e.printStackTrace();
					}	
			...
			System.out.println("[Extras][Scheduler] Failed to instantiate method from given class. Have you initialised the Extras scheduler? Method or class may be invalid. Caused by plugin : " + Extras.BaseCommands);
		}
	}
	...
	public void killTask(String taskReference) {
		...
		System.out.println("[Extras][Scheduler] Could not cancel task! No task reference found! Caused by plugin " + Extras.BaseCommands);
