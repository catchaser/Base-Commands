...
public class ExtrasColour extends ColourMethods {
	...
	public void sendColouredMessage(Player p, String message) {
		...
		try{
			...
			System.out.println("[Extras] Error sending coloured message! Caused by plugin : " + Extras.BaseCommands);
			ex.printStackTrace();
		}
	}
	...
	public void sendMultiColouredMessage(Player p, String message) {
		...
		try{
			...
			System.out.println("[Extras] Error broadcasting multi-coloured message! Caused by plugin : " + Extras.BaseCommands);
			ex.printStackTrace();
		}
	}
	...
	public void broadcastColouredMessage(Server s, String message) {
		...
		try{
			...
			System.out.println("[Extras] Error broadcasting coloured message! Caused by plugin : " + Extras.BaseCommands);
			ex.printStackTrace();
		}
	}
